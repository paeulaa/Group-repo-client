    ...
    <div className="body">
      ...
      <div className="section1">
        <div className="introduction">
          <div className="title">
            Embrace the Power of Positivity and Self-Discovery with{" "}
            <b>Good Fortune</b>: Your Path to Happiness and Enlightenment!
          </div>
          <div className="buttons">
            <Link className="nav-link" to="/quotes">
              <div className="register-button" id="quotes">
                <b>Meet Althea here!</b>
              </div>
            </Link>
      ...
      <div className="section2">
        ...
        <div className="right">
          Meet Althea, <br />
          Your Guiding Light to Positivity and Wisdom!
        </div>
      </div>
